            ...
            <li class="nav-item">
                ...
                <div id="collapseArticles" class="collapse" aria-labelledby="headingArticles" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="Articlees/articles.php">View All Articles</a>
                        <a class="collapse-item" href="Articlees/add-article.php">Add New Article</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseCategories" class="collapse" aria-labelledby="headingCategories" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="category/categories.php">View All Categories</a>
                        <a class="collapse-item" href="category/add-category.php">Add New Category</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTags" class="collapse" aria-labelledby="headingTags" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="tags/tags.php">View All Tags</a>
                        <a class="collapse-item" href="tags/add-tag.php">Add New Tag</a>
                    </div>
                </div>
            </li>
